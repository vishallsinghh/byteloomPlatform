...
const SignupForm = ({ onSwitchToLogin }) => {
  ...
  const validateForm = () => {
    ...
    if (formData.password.trim()) {
      ...
      if (Object.values(pwChecks).filter(Boolean).length < 4) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        `${authUrl.BASE_URL}/auth/register/`,
        JSON.stringify({
      ...
      // on 200 or 201, send user to OTP page with email query param
          ...
          <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-200 w-full">
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className={`w-full px-4 py-3 border rounded-lg focus:ring-2 transition-all duration-200 pl-12 ${
            ...
            <div className="mt-6 text-center">
              <p className="text-gray-600">
                ...
                <Link
                  to={'/login'}
                  className="text-blue-500 hover:text-purple-500 font-medium"
                >
                  Sign in
                </Link>
              </p>
